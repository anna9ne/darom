<x-profile-layout>
    ...
    <div class="mt-8 mx-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2">
            ...
            <form action="{{ route('profile.ads.update', $ad) }}" method="POST" enctype="multipart/form-data" class="p-6 flex flex-col justify-center">
                @csrf
                @method('PUT')
                ...
                <div class="flex flex-row mt-2">
                    <input type="checkbox" name="active" id="active" value="1" class=""
                        {{ $ad->active == 1 ? ' checked' : '' }}/>
                ...
                <div class="grid grid-cols-2 mt-4">
                    <a href="{{ route('profile.ads.index') }}" class="md:w-32 bg-white dark:bg-gray-100 text-blue-600 border-2 border-blue-600 dark:text-gray-800 font-bold py-3 px-6 rounded-lg mt-4 hover:bg-blue-200 dark:hover:bg-gray-200 transition ease-in-out duration-300 text-center">Cancel</a>
